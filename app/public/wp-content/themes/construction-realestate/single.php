...
<div class="container" role="main">
    <main id="skip_content" class="main-wrapper">
        ...
        if($construction_realestate_layout_option == 'One Column'){ ?>
			<div id="content_box">
		        <?php if (get_theme_mod('construction_realestate_single_post_bradcrumb',false) != ''){ ?>
					<div class="bradcrumbs">
						<?php construction_realestate_the_breadcrumb(); ?>
					</div>
		    	<?php }?>
	    ...
	    <?php }else if($construction_realestate_layout_option == 'Left Sidebar'){ ?>
	    	<div class="row">
	    		<div id="sidebar" class="<?php if( get_theme_mod( 'construction_realestate_sidebar_size', 'Sidebar 1/3') == 'Sidebar 1/3') { ?>col-lg-4 col-md-4"<?php } else { ?>col-lg-3 col-md-4 <?php } ?>"><?php dynamic_sidebar('sidebar-1'); ?></div>
				<div class="<?php if( get_theme_mod( 'construction_realestate_sidebar_size', 'Sidebar 1/3') == 'Sidebar 1/3') { ?>col-lg-8 col-md-8"<?php } else { ?>col-lg-9 col-md-8 <?php } ?>" id="content_box">
      				<?php if (get_theme_mod('construction_realestate_single_post_bradcrumb',false) != ''){ ?>
		                <div class="bradcrumbs">
		                    <?php construction_realestate_the_breadcrumb(); ?>
		                </div>
