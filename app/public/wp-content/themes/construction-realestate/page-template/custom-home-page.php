...
<main id="skip_content" role="main">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div <?php if($i == 1){echo 'class="carousel-item active"';} else{ echo 'class="carousel-item"';}?>>
            ...
            <div class="carousel-caption">
              <?php if( get_theme_mod('construction_realestate_slider_heading', false) != '' || get_theme_mod( 'construction_realestate_slider_text',false) != ''){ ?>
                <div class="inner_carousel text-center">
                  <?php if( get_theme_mod('construction_realestate_slider_heading',true) != ''){ ?>
                    <h1 class="p-0"><?php the_title(); ?></h1>
                  <?php } ?>
                  <?php if( get_theme_mod('construction_realestate_slider_text',true) != ''){ ?>
                    <p><?php $construction_realestate_excerpt = get_the_excerpt(); echo esc_html( construction_realestate_string_limit_words( $construction_realestate_excerpt, esc_attr(get_theme_mod('construction_realestate_slider_excerpt_number','30')))); ?></p>
                  <?php } ?>
                </div>
              <?php } ?>
  ...
  <?php if (get_theme_mod( 'construction_realestate_show_about_section',true) != ''){ ?>
    ...
    <?php if( get_theme_mod('construction_realestate_sec_title') != '' || get_theme_mod( 'construction_realestate_about_post_setting' )!= ''){ ?>
      <section id="about">
        <div class="container about-box text-center">
            ...
            if ( $query->have_posts() ) :
              while ( $query->have_posts() ) : $query->the_post(); ?>
                <div class="mainbox">
                  ...
                  <p><?php $construction_realestate_excerpt = get_the_excerpt(); echo esc_html( construction_realestate_string_limit_words( $construction_realestate_excerpt, esc_attr(get_theme_mod('construction_realestate_about_excerpt_number','30')))); ?></p>
                  <div class="clearfix"></div>
                </div>
              <?php endwhile; 
              wp_reset_postdata();?>
