...
<div id="comments" class="comments-area mt-5">
	<?php if ( have_comments() ) : ?>
		<h2 class="comments-title pt-1 mb-0">
		    <?php
		    $construction_realestate_comments_number = get_comments_number();
		    if ( 1 === $construction_realestate_comments_number ) {
		        ...
		        /* translators: 1: number of comments, 2: post title */
		            ...
		            esc_html( _nx(
		                ...
		                $construction_realestate_comments_number,
		                'comments title',
		                'construction-realestate'

		            ) ),
		            esc_html (number_format_i18n( $construction_realestate_comments_number ) ),
