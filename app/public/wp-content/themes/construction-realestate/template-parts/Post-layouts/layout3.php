...
<article id="post-<?php the_ID(); ?>" <?php post_class('inner-service'); ?>>
  ...
  <div class="mainbox-post p-4">
    <h2 class="section-title mb-2"><a href="<?php echo esc_url( get_permalink() ); ?>" title="<?php echo the_title_attribute(); ?>"><?php the_title(); ?><span class="screen-reader-text"><?php the_title(); ?></span></a></h2>
