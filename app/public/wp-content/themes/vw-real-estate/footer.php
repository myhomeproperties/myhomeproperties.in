    ...
    <div class="footer-2">
        <div class="container">
              	<div class="copyright text-center">
                    <p><?php vw_real_estate_credit(); ?> <?php echo esc_html(get_theme_mod('vw_construction_estate_footer_copy',__('By VWThemes','vw-real-estate'))); ?></p>
                    ...
                    <?php if( get_theme_mod( 'vw_construction_estate_hide_show_scroll',true) == 1 || get_theme_mod( 'vw_construction_estate_resp_scroll_top_hide_show',true) == 1) { ?>
                        ...
                        if($vw_construction_estate_theme_lay == 'Left'){ ?>
                            <a href="#" class="scrollup left"><i class="<?php echo esc_attr(get_theme_mod('vw_construction_estate_scroll_top_icon','fas fa-long-arrow-alt-up')); ?>"></i><span class="screen-reader-text"><?php esc_html_e( 'Scroll Up', 'vw-real-estate' ); ?></span></a>
                        <?php }else if($vw_construction_estate_theme_lay == 'Center'){ ?>
                            <a href="#" class="scrollup center"><i class="<?php echo esc_attr(get_theme_mod('vw_construction_estate_scroll_top_icon','fas fa-long-arrow-alt-up')); ?>"></i><span class="screen-reader-text"><?php esc_html_e( 'Scroll Up', 'vw-real-estate' ); ?></span></a>
                        <?php }else{ ?>
                            <a href="#" class="scrollup"><i class="<?php echo esc_attr(get_theme_mod('vw_construction_estate_scroll_top_icon','fas fa-long-arrow-alt-up')); ?>"></i><span class="screen-reader-text"><?php esc_html_e( 'Scroll Up', 'vw-real-estate' ); ?></span></a>
                        <?php }?>
                    <?php }?>
              	</div>
            <div class="clear"></div>
