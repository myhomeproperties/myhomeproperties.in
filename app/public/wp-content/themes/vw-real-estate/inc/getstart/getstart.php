...
<div class="wrapper-info">
    ...
    <div class="tab-sec">
		<div class="tab">
			...
			<button class="tablinks" onclick="vw_real_estate_open_tab(event, 'product_addons_editor')"><?php esc_html_e( 'Woocommerce Product Addons', 'vw-real-estate' ); ?></button> 
		...
		<div id="product_addons_editor" class="tabcontent">
			<?php if(!class_exists('IEPA_Loader')){
				$plugin_ins = VW_Real_Estate_Plugin_Activation_Woo_Products::get_instance();
				$vw_real_estate_actions = $plugin_ins->recommended_actions;
				?>
				<div class="vw-real-estate-recommended-plugins">
					    <div class="vw-real-estate-action-list">
			...
			<?php }else{ ?>
				<h3><?php esc_html_e( 'Woocommerce Products Blocks', 'vw-real-estate' ); ?></h3>
				<hr class="h3hr">
				<div class="vw-real-estate-pattern-page">
					<p><?php esc_html_e('Follow the below instructions to setup Products Templates.','vw-real-estate'); ?></p>
					<p><b><?php esc_html_e('1. First you need to activate these plugins','vw-real-estate'); ?></b></p>
						<p><?php esc_html_e('1. Ibtana - WordPress Website Builder ','vw-real-estate'); ?></p>
						<p><?php esc_html_e('2. Ibtana - Ecommerce Product Addons.','vw-real-estate'); ?></p>
						<p><?php esc_html_e('3. Woocommerce','vw-real-estate'); ?></p>

					<p><b><?php esc_html_e('2. Go To Dashboard >> Ibtana Settings >> Woocommerce Templates','vw-real-estate'); ?></span></b></p>
	              	<div class="vw-real-estate-pattern-page">
			    		<a href="<?php echo esc_url( admin_url( 'admin.php?page=ibtana-visual-editor-woocommerce-templates&ive_wizard_view=parent' ) ); ?>" class="vw-pattern-page-btn ibtana-dashboard-page-btn button-primary button"><?php esc_html_e('Woocommerce Templates','vw-real-estate'); ?></a>
			    	</div>
	              	<p><?php esc_html_e('You can create a template as you like.','vw-real-estate'); ?></span></p>
			    </div>
			<?php } ?>
		</div>
		...
		<div id="theme_pro" class="tabcontent">
		    ...
		    <div class="col-left-pro">
		    	...
		    	<div class="pro-links">
					...
					<a href="<?php echo esc_url( VW_REAL_ESTATE_BUY_NOW ); ?>" target="_blank"><?php esc_html_e('Buy Pro', 'vw-real-estate'); ?></a>
