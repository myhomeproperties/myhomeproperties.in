<?php
	...
	if($vw_construction_estate_second_color != false){
		$vw_construction_estate_custom_css .='.footer h3, entry-content a, .sidebar .textwidget p a, .textwidget p a, #comments p a, .slider .inner_carousel p a, .main-navigation ul.sub-menu a:hover, a,.header-menu i, .sidebar ul li a:hover, .footer li a:hover, .page-template-custom-home-page p.call-no a:hover, p.call-no a:hover, p.diff-lay a:hover, .footer .wp-block-search .wp-block-search__label{';
			$vw_construction_estate_custom_css .='color: '.esc_attr($vw_construction_estate_second_color).';';
		$vw_construction_estate_custom_css .='}';
	}
	if($vw_construction_estate_second_color != false){
		$vw_construction_estate_custom_css .='.page-template-custom-home-page .logo .site-title a:hover, .logo .site-title a:hover{';
			$vw_construction_estate_custom_css .='color: '.esc_attr($vw_construction_estate_second_color).'!important;';
		$vw_construction_estate_custom_css .='}';
	}
	if($vw_construction_estate_second_color != false){
		$vw_construction_estate_custom_css .='.contact-btn a, .footer h3, .footer a.custom_read_more, hr.big, .main-navigation ul ul, a.button:hover, .woocommerce-message, .footer .custom-social-icons i, .footer .wp-block-search .wp-block-search__label{';
	...
	if($vw_construction_estate_footer_background_image != false){
		$vw_construction_estate_custom_css .='.footer{';
			$vw_construction_estate_custom_css .='background: url('.esc_attr($vw_construction_estate_footer_background_image).')!important;';
		$vw_construction_estate_custom_css .='}';
	}