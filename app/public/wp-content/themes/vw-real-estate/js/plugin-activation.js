jQuery(document).ready(function($) {
    'use strict';
    var this_obj = vw_real_estate_plugin_activate_plugin;
    ...
    $(document).on('click', '.vw-real-estate-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message vw-real-estate-plugin-install');
                button.addClass('button-primary vw-real-estate-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.vw-real-estate-recommended-plugins .vw-real-estate-activation-note').css('display','block');
    ...
    $(document).on('click', '.vw-real-estate-plugin-activate', function(event) {
    ...
    jQuery('#lite_theme .ibtana-skip-btn').click(function(){
        ...
        jQuery('#lite_theme .vw-real-estate-recommended-plugins').css('display','none');
    });

    jQuery('#block_pattern .ibtana-skip-btn').click(function(){
        var light_theme = jQuery(this).attr('get-start-tab-id');
        jQuery('.' + light_theme).css('display','block');
        jQuery('#block_pattern .vw-real-estate-recommended-plugins').css('display','none');
    });
