<?php
	...
	$vw_construction_estate_nav_menus_font_weight = get_theme_mod( 'vw_construction_estate_navigation_menu_font_weight','Default');
    if($vw_construction_estate_nav_menus_font_weight == 'Default'){
		$vw_construction_estate_custom_css .='.main-navigation a{';
			$vw_construction_estate_custom_css .='';
		$vw_construction_estate_custom_css .='}';
	}else if($vw_construction_estate_nav_menus_font_weight == 'Normal'){
		$vw_construction_estate_custom_css .='.main-navigation a{';
			$vw_construction_estate_custom_css .='font-weight: normal;';
		$vw_construction_estate_custom_css .='}';
	}
